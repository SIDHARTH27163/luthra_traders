...
<footer class="bg-gray-800">
    <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
        <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
            <div>
                <h3 class="mb-6 text-sm font-semibold text-gray-100 uppercase dark:text-white">Company</h3>
            ...
            <div>
                <h3 class="mb-6 text-sm font-semibold uppercase text-white">Help center</h3>
                <ul class="text-gray-400">
                    <li class="mb-4">
            ...
            <div>
                <h3 class="mb-6 text-sm font-semibold  uppercase text-white">Download</h3>
                <ul class="text-gray-400">
                    <li class="mb-4">
        ...
        <div class="text-center">
            ...
            <span class="block text-sm text-center text-gray-100">© 2021-2022 Landwind™. All Rights Reserved. Built with <a href="https://flowbite.com" class="text-purple-600 hover:underline dark:text-purple-500">Flowbite</a> and <a href="https://tailwindcss.com" class="text-purple-600 hover:underline dark:text-purple-500">Tailwind CSS</a>. Distributed by <a href="https://themewagon.com/" class="text-purple-600 hover:underline dark:text-purple-500">ThemeWagon</a>
            </span>

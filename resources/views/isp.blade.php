		...
		<div class="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start py-24">
			...
			<div class="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
				<h1 data-aos="fade-right" data-aos-once="true" class="my-4 text-5xl font-bold leading-tight text-white">
					<span class="text-yellow-500">Connect</span> to Internet more easier
				</h1>
				<p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" class="leading-normal text-2xl mb-8 text-gray-200">Welcome to JioFiber Installation Services, your gateway to high-speed internet connectivity and a world of digital convenience! </p>
...
<section class="cards pb-1 max-w-7xl mx-auto container">
  ...
  <div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-10">
    ...
    <div data-aos="fade-up" data-aos-delay="150" class="bg-white shadow-xl p-6 text-center rounded-xl">
      ...
      <h1 class="font-medium text-xl mb-3 lg:px-14 text-darken">Easy Scheduling </h1>
      <p class="px-4 text-gray-500">
        Experience hassle-free scheduling with JioFiber installation. Our user-friendly system lets you choose the installation time that suits you best. Simply select from available slots online or through our customer service. We value your time and aim to make the process effortless. With just a few clicks or a quick call, set up the installation at your convenience.</p>
    </div>
    <div data-aos="fade-up" data-aos-delay="300" class="bg-white shadow-xl p-6 text-center rounded-xl">
      ...
      <h1 class="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14 pt-3">Multiple Customers</h1>
      <p class="px-4 text-gray-500">With our high-speed connectivity and reliable service, we're dedicated to meeting your diverse needs. From seamless installations to round-the-clock support, we're committed to ensuring your satisfaction. </p>
    </div>
  </div>
</section>

<section class="max-w-7xl container mx-auto pb-12">

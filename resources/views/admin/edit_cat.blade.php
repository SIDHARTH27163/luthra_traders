...
<div class="p-4  rounded-lg  border-2 border-slate-900 border-dashed h-auto">
   ...
   <div class="w-full p-4 ">
      ...
      <p class="toggleColour text-gray-900 text-2xl  font-bold underline py-2">Edit Category</p>
      <div class="h-full  w-full  flex flex-col  items-center justify-center ">
       ...
       {{-- form for add location starts --}}
          <form action="{{url('edit_cats/'.$udata->id)}}" method="post" class="lg:w-3/4 md:w-3/4 sm:w-3/4 w-full bg-white p-4  rounded-lg shadow-lg  ">
              @csrf
              @method('post')
              <div class="mb-4">
                <label for="name" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Add Category</label>
                <input type="text" value="{{ $udata->category }}" name="category" id="text" class="bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="eg:	Common Area and Amenities , Food">

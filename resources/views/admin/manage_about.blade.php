...
<div class="w-full py-10 px-2 ">
    ...
    <p class="toggleColour text-gray-900 text-2xl  font-bold underline py-2"> Action Over About</p>
           ...
           <tbody>
            ...
            <tr class=" border-b bg-gray-900 border-gray-700 text-white font-semibold">
                ...
                <td class="px-3 py-4">
                 ...
                 <td>
                    <img src="{{ asset('traders/'.$data->image) }}" style="height: 50px;width:50px;">
                 </td>
                <td class="px-1 py-4 text-center">
                  
                    <a href="{{url('edit_about/'.$data->id)}}" class="font-medium text-orange-400 dark:text-orange-500 hover:underline">Edit</a><br>

...
<div class="p-2  rounded-lg  border-2 border-slate-900 border-dashed h-auto">
  <div class="grid  grid-cols-2 gap-4 mb-4">
   ...
   <div class="w-full p-4 ">
      ...
      <p class="toggleColour text-gray-900 text-2xl  font-bold underline py-2">Manage Cable tv Package</p>
      <div class="h-full  w-full  flex flex-col  items-center justify-center ">
       ...
       {{-- form for add location starts --}}
          <form action="add_pack" enctype="multipart/form-data" method="post" class="lg:w-3/4 md:w-3/4 sm:w-3/4 w-full bg-white p-4  rounded-lg shadow-lg  ">
              @csrf
              @method('post')
              <div class="mb-4">
                <label for="name" class="block mb-2 text-lg font-semibold text-gray-900 dark:text-white">Add Pack Name</label>
                <input type="text" name="pack_name" id="text" class="bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="eg:pack name">
    ...
    @endif
              ...
              <div class="mb-4">
                ...
                <input type="text" name="total_channels" id="text" class="bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="eg:100">
    ...
    @endif
              ...
              <div class="mb-4">
                ...
                <input type="text" name="pack_price" id="text" class="bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="120">
    ...
    @endif
              ...
              <div class="mb-2">
                ...
                <input type="file" name="pdf" id="text" class="bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="eg:1Month ,  1 week">
                @if($errors->has('pdf'))
           ...
           <tbody>
            ...
            <tr class=" border-b bg-gray-900 border-gray-700 text-white font-semibold">
                ...
                <td class="px-3 py-4">
                 ...
                 <td>
                    <a target="_blank" href="{{ asset('pdfs/'.$data->pdf) }}" >view</a>
                 </td>
                <td class="px-1 py-4 text-center">
                   <a href="{{url('delete_pack/'.$data->id)}}" class="font-medium text-rose-600 dark:text-rose-500 hover:underline">Delete</a><br>

                   <a href="{{url('change_pack_status/'.$data->id)}}" class="font-medium text-orange-400 dark:text-orange-500 hover:underline">Change Status</a><br>
                   <a href="{{url('edit_pack/'.$data->id)}}" class="font-medium text-orange-400 dark:text-orange-500 hover:underline">Edit</a><br>

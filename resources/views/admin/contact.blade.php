...
<div class="p-4  rounded-lg  border-2 border-slate-900 border-dashed h-auto">
 ...
 <div class="w-full p-4 ">
    ...
    <p class="toggleColour text-gray-900 text-2xl  font-bold underline py-2"> Contact Request Waiting For Approvals</p>
           ...
           <tbody>
             ...
             <tr class=" border-b bg-gray-900 border-gray-700 text-white font-semibold">
                ...
                <td class="px-1 py-4 text-center">
                    <a href="{{url('delete_contact_req/'.$d_tata->id)}}" class="font-medium text-rose-600 dark:text-rose-500 hover:underline">Delete</a><br>

                    <a href="{{url('change_contact_req_status/'.$d_tata->id)}}" class="font-medium text-orange-400 dark:text-orange-500 hover:underline">Activate/Deactivate</a><br>
...
<div class="w-full p-4 ">
    ...
    <p class="toggleColour text-gray-900 text-2xl  font-bold underline py-2"> Approved Contact Requests</p>
    <div class="relative overflow-auto shadow-md sm:rounded-lg">
       <table class="w-full text-sm text-left text-gray-500 ">
           <thead class="text-xs text-gray-100 uppercase bg-gray-700 ">
               <tr>
           ...
           <tbody>
             ...
             <tr class=" border-b bg-gray-900 border-gray-700 text-white font-semibold">
                ...
                <td class="px-1 py-4 text-center">
                   <a href="{{url('delete_contact_req/'.$data->id)}}" class="font-medium text-rose-600 dark:text-rose-500 hover:underline">Delete</a><br>

                   <a href="{{url('change_contact_req_status/'.$data->id)}}" class="font-medium text-orange-400 dark:text-orange-500 hover:underline">Activate/Deactivate</a><br>

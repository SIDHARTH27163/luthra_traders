           ...
           <tbody>
             ...
             <tr class=" border-b bg-gray-900 border-gray-700 text-white font-semibold">
                ...
                <td class="px-1 py-4 text-center">
                    <a href="{{url('delete_cable_req/'.$d_tata->id)}}" class="font-medium text-rose-600 dark:text-rose-500 hover:underline">Delete</a><br>

                    <a href="{{url('change_cable_req_status/'.$d_tata->id)}}" class="font-medium text-orange-400 dark:text-orange-500 hover:underline">Activate/Deactivate</a><br>
       ...
       <table class="w-full text-sm text-left text-gray-500 ">
           ...
           <tbody>
             ...
             <tr class=" border-b bg-gray-900 border-gray-700 text-white font-semibold">
                ...
                <td class="px-1 py-4 text-center">
                   <a href="{{url('delete_cable_req/'.$data->id)}}" class="font-medium text-rose-600 dark:text-rose-500 hover:underline">Delete</a><br>
